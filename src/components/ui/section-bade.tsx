...
export const SectionBadge = ({ title }: Props) => {
    return (
      ...
      <div className="px-4 py-1 rounded-full bg-primary/20 cursor-pointer select-none">
        <div
          className="bg-[linear-gradient(110deg,#1e3a8a,45%,#60a5fa,55%,#1e3a8a)] bg-[length:250%_100%] bg-clip-text animate-background-shine text-transparent font-medium text-sm"
        >
          {title}
        </div>
      </div>
